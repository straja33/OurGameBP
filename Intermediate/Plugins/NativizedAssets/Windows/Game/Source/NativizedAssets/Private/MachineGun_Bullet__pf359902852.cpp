...
#include "MachineGun_Bullet__pf359902852.h"
...
AMachineGun_Bullet_C__pf359902852::AMachineGun_Bullet_C__pf359902852(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AMachineGun_Bullet_C__pf359902852::StaticClass() == GetClass()))
	{
		AMachineGun_Bullet_C__pf359902852::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__ProjectileMovement__pf->InitialSpeed = 18000.000000f;
	bpv__ProjectileMovement__pf->MaxSpeed = 18000.000000f;
	bpv__ProjectileMovement__pf->ProjectileGravityScale = 0.000000f;
	bpv__ProjectileMovement__pf->Velocity = FVector(18000.000000, 0.000000, 0.000000);
	...
	__Local__0 = FVector(1.000000, 1.000000, 1.000000);
	...
	__Local__1 = ECollisionChannel::ECC_GameTraceChannel1;
	...
	bpv__Box__pf->RelativeScale3D = FVector(14.281250, 10.437500, 6.968750);
	...
	auto& __Local__10 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Cube__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__10 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AMachineGun_Bullet_C__pf359902852::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AMachineGun_Bullet_C__pf359902852::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__Cube__pf->BodyInstance.SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__11 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__Cube__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__11 = ECollisionChannel::ECC_GameTraceChannel1;
	auto& __Local__12 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__Cube__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__12 = ECollisionEnabled::Type::QueryOnly;
	bpv__Cube__pf->BodyInstance.bEnableGravity = false;
	auto& __Local__13 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Cube__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	__Local__14.AddUninitialized(7);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__14.GetData(), 7);
	auto& __Local__15 = __Local__14[0];
	__Local__15.Channel = FName(TEXT("Enemy_Human"));
	__Local__15.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__16 = __Local__14[1];
	__Local__16.Channel = FName(TEXT("Friendly"));
	__Local__16.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__17 = __Local__14[2];
	__Local__17.Channel = FName(TEXT("NasTrigger"));
	__Local__17.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__18 = __Local__14[3];
	__Local__18.Channel = FName(TEXT("Enemy_Bullet"));
	__Local__18.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__19 = __Local__14[4];
	__Local__19.Channel = FName(TEXT("Bullet"));
	__Local__19.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__20 = __Local__14[5];
	__Local__20.Channel = FName(TEXT("Enemy_Trigger"));
	__Local__20.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__21 = __Local__14[6];
	__Local__21.Channel = FName(TEXT("OurHero"));
	__Local__21.Response = ECollisionResponse::ECR_Ignore;
	bpv__Cube__pf->BodyInstance.MassScale = 0.000000f;
	bpv__Cube__pf->RelativeLocation = FVector(0.000000, 0.000000, -0.100000);
	bpv__Cube__pf->RelativeScale3D = FVector(0.017857, 0.014706, 0.020833);
...
void AMachineGun_Bullet_C__pf359902852::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AMachineGun_Bullet_C__pf359902852::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__22 = NewObject<USceneComponent>(InDynamicClass, USceneComponent::StaticClass(), TEXT("DefaultSceneRoot_GEN_VARIABLE"));
	InDynamicClass->ComponentTemplates.Add(__Local__22);
	auto __Local__23 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"));
	InDynamicClass->DynamicBindingObjects.Add(__Local__23);
	__Local__22->bVisible = false;
	__Local__23->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__23->ComponentDelegateBindings.AddUninitialized(1);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__23->ComponentDelegateBindings.GetData(), 1);
	auto& __Local__24 = __Local__23->ComponentDelegateBindings[0];
	__Local__24.ComponentPropertyName = FName(TEXT("Box"));
	__Local__24.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__24.FunctionNameToBind = FName(TEXT("BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AMachineGun_Bullet_C__pf359902852::bpf__ExecuteUbergraph_MachineGun_Bullet__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_ApplyDamage_ReturnValue__pf = UGameplayStatics::ApplyDamage(b0l__K2Node_ComponentBoundEvent_OtherActor__pf, 10.000000, ((AController*)nullptr), this, ((UClass*)nullptr));
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = AActor::K2_GetActorLocation();
	bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AMachineGun_Bullet_C__pf359902852::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), FVector(0.500000,0.500000,0.500000), true, EPSCPoolMethod::None);
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void AMachineGun_Bullet_C__pf359902852::bpf__ExecuteUbergraph_MachineGun_Bullet__pf_1(int32 bpp__EntryPoint__pf)
{
	FVector bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf(EForceInit::ForceInit);
	UParticleSystemComponent* bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue1__pf{};
	...
	bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue1__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AMachineGun_Bullet_C__pf359902852::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), FVector(0.150000,0.150000,0.150000), true, EPSCPoolMethod::None);
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void AMachineGun_Bullet_C__pf359902852::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
...
void AMachineGun_Bullet_C__pf359902852::bpf__ReceiveHit__pf(UPrimitiveComponent* bpp__MyComp__pf, AActor* bpp__Other__pf, UPrimitiveComponent* bpp__OtherComp__pf, bool bpp__bSelfMoved__pf, FVector bpp__HitLocation__pf, FVector bpp__HitNormal__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	...
	bpf__ExecuteUbergraph_MachineGun_Bullet__pf_1(3);
}
void AMachineGun_Bullet_C__pf359902852::bpf__UserConstructionScript__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void AMachineGun_Bullet_C__pf359902852::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{74, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/Igra/Textures/Prison_Level/Bullet_Mat.Bullet_Mat 
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AMachineGun_Bullet_C__pf359902852::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AMachineGun_Bullet_C__pf359902852
{
	FRegisterHelper__AMachineGun_Bullet_C__pf359902852()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Igra/Oruzje/Ammunition/MachineGun_Bullet"), &AMachineGun_Bullet_C__pf359902852::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AMachineGun_Bullet_C__pf359902852 Instance;
};
FRegisterHelper__AMachineGun_Bullet_C__pf359902852 FRegisterHelper__AMachineGun_Bullet_C__pf359902852::Instance;
