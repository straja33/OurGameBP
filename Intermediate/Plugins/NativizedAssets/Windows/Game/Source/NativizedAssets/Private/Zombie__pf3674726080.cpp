...
#include "Zombie__pf3674726080.h"
...
AZombie_C__pf3674726080::AZombie_C__pf3674726080(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AZombie_C__pf3674726080::StaticClass() == GetClass()))
	{
		AZombie_C__pf3674726080::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	__Local__11 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__StaticMesh__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__StaticMesh__pf->OverrideMaterials.Reserve(1);
	bpv__StaticMesh__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	auto& __Local__19 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Box__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	bpv__DeathSounds__pf.Add(CastChecked<USoundBase>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed));
	bpv__DeathSounds__pf.Add(CastChecked<USoundBase>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed));
	bpv__DeathSounds__pf.Add(CastChecked<USoundBase>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed));
	bpv__DeathSounds__pf.Add(CastChecked<USoundBase>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed));
	bpv__DeathSounds__pf.Add(CastChecked<USoundBase>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[6], ECastCheckedType::NullAllowed));
	bpv__DeathSounds__pf.Add(CastChecked<USoundBase>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[7], ECastCheckedType::NullAllowed));
	...
	bpv__AttackSound__pf = CastChecked<USoundBase>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[8], ECastCheckedType::NullAllowed);
	bpv__IdleMaterial__pf = CastChecked<UMaterial>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	bpv__AttackMaterial__pf = CastChecked<UMaterial>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[9], ECastCheckedType::NullAllowed);
	bpv__DeathMaterial__pf = CastChecked<UMaterial>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[10], ECastCheckedType::NullAllowed);
	auto& __Local__32 = (*(AccessPrivateProperty<USkeletalMeshComponent*>((this), ACharacter::__PPO__Mesh() )));
	__Local__32 = __Local__2;
	auto& __Local__33 = (*(AccessPrivateProperty<UCharacterMovementComponent*>((this), ACharacter::__PPO__CharacterMovement() )));
	__Local__33 = __Local__1;
	auto& __Local__34 = (*(AccessPrivateProperty<UCapsuleComponent*>((this), ACharacter::__PPO__CapsuleComponent() )));
	__Local__34 = __Local__0;
...
void AZombie_C__pf3674726080::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AZombie_C__pf3674726080::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__35 = NewObject<USceneComponent>(InDynamicClass, USceneComponent::StaticClass(), TEXT("DefaultSceneRoot_GEN_VARIABLE"));
	InDynamicClass->ComponentTemplates.Add(__Local__35);
}
PRAGMA_ENABLE_OPTIMIZATION
void AZombie_C__pf3674726080::bpf__ExecuteUbergraph_Zombie__pf_0(int32 bpp__EntryPoint__pf)
{
...
void AZombie_C__pf3674726080::bpf__ExecuteUbergraph_Zombie__pf_1(int32 bpp__EntryPoint__pf)
{
...
void AZombie_C__pf3674726080::bpf__ReceiveAnyDamage__pf(float bpp__Damage__pf, const UDamageType* bpp__DamageType__pf__const, AController* bpp__InstigatedBy__pf, AActor* bpp__DamageCauser__pf)
{
	typedef UDamageType*  T__Local__36;
	T__Local__36& bpp__DamageType__pf = *const_cast<T__Local__36 *>(&bpp__DamageType__pf__const);
	...
	bpf__ExecuteUbergraph_Zombie__pf_0(4);
}
void AZombie_C__pf3674726080::bpf__ReceivePossessed__pf(AController* bpp__NewController__pf)
{
	b0l__K2Node_Event_NewController__pf = bpp__NewController__pf;
	bpf__ExecuteUbergraph_Zombie__pf_1(2);
}
void AZombie_C__pf3674726080::bpf__UserConstructionScript__pf()
{
}
void AZombie_C__pf3674726080::bpf__Damage_Function__pf()
{
	...
	do
	{
		...
		case 1:
			{
				bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AZombie_C__pf3674726080::StaticClass())->UsedAssets[11], ECastCheckedType::NullAllowed), bpv__BulletLocation__pf, FRotator(0.000000,0.000000,0.000000), FVector(0.400000,0.400000,0.400000), true, EPSCPoolMethod::None);
			}
		case 2:
			{
...
void AZombie_C__pf3674726080::bpf__Impulse_Function__pf()
{
...
void AZombie_C__pf3674726080::bpf__DamagePlayer_Function__pf(APawn* bpp__SensedPlayer__pf)
{
...
void AZombie_C__pf3674726080::bpf__SetAttackTrue__pf()
{
	bpv__CanAttackx__pfzy = true;
}
void AZombie_C__pf3674726080::bpf__SetMaterial__pf()
{
	int32 __CurrentState = 1;
	do
	{
...
PRAGMA_DISABLE_OPTIMIZATION
void AZombie_C__pf3674726080::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AZombie_C__pf3674726080::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AZombie_C__pf3674726080
{
	FRegisterHelper__AZombie_C__pf3674726080()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Igra/AI/BasicAIMeele/Zombie"), &AZombie_C__pf3674726080::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AZombie_C__pf3674726080 Instance;
};
FRegisterHelper__AZombie_C__pf3674726080 FRegisterHelper__AZombie_C__pf3674726080::Instance;
