...
#include "Grenade_PickUp__pf3971847853.h"
...
AGrenade_PickUp_C__pf3971847853::AGrenade_PickUp_C__pf3971847853(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AGrenade_PickUp_C__pf3971847853::StaticClass() == GetClass()))
	{
		AGrenade_PickUp_C__pf3971847853::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AGrenade_PickUp_C__pf3971847853::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AGrenade_PickUp_C__pf3971847853::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	__Local__6.Channel = FName(TEXT("OurHero"));
	...
	bpv__RotatingMovement__pf->bRotationInLocalSpace = false;
	PrimaryActorTick.bStartWithTickEnabled = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void AGrenade_PickUp_C__pf3971847853::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AGrenade_PickUp_C__pf3971847853::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AGrenade_PickUp_C__pf3971847853::bpf__ExecuteUbergraph_Grenade_PickUp__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	int32  __Local__22 = 0;
	bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(((::IsValid(b0l__K2Node_DynamicCast_AsOur_Hero__pf)) ? (b0l__K2Node_DynamicCast_AsOur_Hero__pf->bpv__Grenade_Number__pf) : (__Local__22)), 1);
	b0l__Temp_int_Variable__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
	if(::IsValid(b0l__K2Node_DynamicCast_AsOur_Hero__pf))
	{
		b0l__K2Node_DynamicCast_AsOur_Hero__pf->bpv__Grenade_Number__pf = b0l__Temp_int_Variable__pf;
	}
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UGlobalPickUP_C__pf3966595016>(UWidgetBlueprintLibrary::Create(this, UGlobalPickUP_C__pf3966595016::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
	...
	TEXT("GRENADE ACQUIRED"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("3C36E99A4F4CE625B27C02B49B96A2DD") /* Key */
	);
	}
	// optimized KCST_UnconditionalGoto
	K2_DestroyActor();
...
void AGrenade_PickUp_C__pf3971847853::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Grenade_PickUp__pf_0(2);
}
void AGrenade_PickUp_C__pf3971847853::bpf__UserConstructionScript__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void AGrenade_PickUp_C__pf3971847853::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AGrenade_PickUp_C__pf3971847853::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AGrenade_PickUp_C__pf3971847853
{
	FRegisterHelper__AGrenade_PickUp_C__pf3971847853()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Igra/Oruzje/Grenade_PickUp"), &AGrenade_PickUp_C__pf3971847853::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AGrenade_PickUp_C__pf3971847853 Instance;
};
FRegisterHelper__AGrenade_PickUp_C__pf3971847853 FRegisterHelper__AGrenade_PickUp_C__pf3971847853::Instance;
