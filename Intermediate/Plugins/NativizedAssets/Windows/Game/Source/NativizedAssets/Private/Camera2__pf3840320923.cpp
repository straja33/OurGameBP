...
ACamera2_C__pf3840320923::ACamera2_C__pf3840320923(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ACamera2_C__pf3840320923::StaticClass() == GetClass()))
	{
		ACamera2_C__pf3840320923::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__ProjectileMovement__pf->MaxSpeed = 350.000000f;
	bpv__ProjectileMovement__pf->bInitialVelocityInLocalSpace = false;
	...
	__Local__0 = FVector(24.603437, 24.603437, 70.000000);
	...
	__Local__12.Channel = FName(TEXT("Enemy_Bullet"));
	__Local__12.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__13 = __Local__3[9];
	__Local__13.Channel = FName(TEXT("Enemy_Trigger"));
	__Local__13.Response = ECollisionResponse::ECR_Ignore;
	bpv__Box__pf->RelativeScale3D = FVector(0.031250, 0.062500, 0.062500);
	...
	bpv__Camera__pf->AttachToComponent(bpv__Box__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Camera__pf->FieldOfView = 100.000000f;
	bpv__Camera__pf->bUsePawnControlRotation = true;
	bpv__DeathTime__pf = 0.000000f;
	bpv__RanOnce__pf = false;
	bReplicateMovement = true;
}
PRAGMA_ENABLE_OPTIMIZATION
void ACamera2_C__pf3840320923::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ACamera2_C__pf3840320923::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UGameOver_C__pf534478733::StaticClass());
	...
	__Local__14->bVisible = false;
}
PRAGMA_ENABLE_OPTIMIZATION
void ACamera2_C__pf3840320923::bpf__ExecuteUbergraph_Camera2__pf_0(int32 bpp__EntryPoint__pf)
{
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue__pf{};
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue1__pf{};
	UGameOver_C__pf534478733* bpfv__CallFunc_Create_ReturnValue__pf{};
	...
	bpfv__CallFunc_SpawnSound2D_ReturnValue__pf = UGameplayStatics::SpawnSound2D(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(ACamera2_C__pf3840320923::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed), 1.000000, 1.000000, 0.000000, ((USoundConcurrency*)nullptr), false, true);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
	UWidgetBlueprintLibrary::SetInputMode_UIOnlyEx(bpfv__CallFunc_GetPlayerController_ReturnValue__pf, ((UWidget*)nullptr), EMouseLockMode::DoNotLock);
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UGameOver_C__pf534478733>(UWidgetBlueprintLibrary::Create(this, UGameOver_C__pf534478733::StaticClass(), ((APlayerController*)nullptr)), ECastCheckedType::NullAllowed);
	...
	{
		bpfv__CallFunc_GetPlayerController_ReturnValue1__pf->bShowMouseCursor = true;
	}
	bpfv__CallFunc_SetGamePaused_ReturnValue__pf = UGameplayStatics::SetGamePaused(this, true);
	return; // KCST_GotoReturn
}
void ACamera2_C__pf3840320923::bpf__ReceiveHit__pf(UPrimitiveComponent* bpp__MyComp__pf, AActor* bpp__Other__pf, UPrimitiveComponent* bpp__OtherComp__pf, bool bpp__bSelfMoved__pf, FVector bpp__HitLocation__pf, FVector bpp__HitNormal__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	typedef FHitResult  T__Local__15;
	T__Local__15& bpp__Hit__pf = *const_cast<T__Local__15 *>(&bpp__Hit__pf__const);
	...
	bpf__ExecuteUbergraph_Camera2__pf_0(6);
}
void ACamera2_C__pf3840320923::bpf__UserConstructionScript__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void ACamera2_C__pf3840320923::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{51, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  SoundWave /Game/Igra/Sounds/Death_Sound.Death_Sound 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ACamera2_C__pf3840320923::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{53, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Igra/Widgets/DeathMenu/GameOver.GameOver_C 
	};
	for(const FCompactBlueprintDependencyData& CompactData : LocCompactBlueprintDependencyData)
	{
		AssetsToLoad.Add(FBlueprintDependencyData(F__NativeDependencies::Get(CompactData.ObjectRefIndex), CompactData));
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ACamera2_C__pf3840320923
{
	FRegisterHelper__ACamera2_C__pf3840320923()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Igra/Hero/Camera2"), &ACamera2_C__pf3840320923::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ACamera2_C__pf3840320923 Instance;
};
FRegisterHelper__ACamera2_C__pf3840320923 FRegisterHelper__ACamera2_C__pf3840320923::Instance;
