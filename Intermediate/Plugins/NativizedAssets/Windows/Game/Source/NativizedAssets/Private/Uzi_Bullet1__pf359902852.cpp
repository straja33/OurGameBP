...
AUzi_Bullet1_C__pf359902852::AUzi_Bullet1_C__pf359902852(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AUzi_Bullet1_C__pf359902852::StaticClass() == GetClass()))
	{
		AUzi_Bullet1_C__pf359902852::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__ProjectileMovement__pf->InitialSpeed = 17000.000000f;
	bpv__ProjectileMovement__pf->MaxSpeed = 17000.000000f;
	bpv__ProjectileMovement__pf->ProjectileGravityScale = 0.000000f;
	bpv__ProjectileMovement__pf->Velocity = FVector(17000.000000, 0.000000, 0.000000);
	...
	auto& __Local__5 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Cube__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__5 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AUzi_Bullet1_C__pf359902852::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AUzi_Bullet1_C__pf359902852::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__Cube__pf->BodyInstance.SetCollisionProfileName(FName(TEXT("Custom")));
	auto& __Local__6 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionChannel> >(&(bpv__Cube__pf->BodyInstance), FBodyInstance::__PPO__ObjectType() )));
	__Local__6 = ECollisionChannel::ECC_GameTraceChannel1;
	auto& __Local__7 = (*(AccessPrivateProperty<TEnumAsByte<ECollisionEnabled::Type> >(&(bpv__Cube__pf->BodyInstance), FBodyInstance::__PPO__CollisionEnabled() )));
	__Local__7 = ECollisionEnabled::Type::QueryOnly;
	bpv__Cube__pf->BodyInstance.bEnableGravity = false;
	auto& __Local__8 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Cube__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	...
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__9.GetData(), 1);
	auto& __Local__10 = __Local__9[0];
	__Local__10.Channel = FName(TEXT("OurHero"));
	...
	bpv__ObjectClass__pf = TArray<UClass*> ();
	bpv__ObjectClass__pf.Reserve(2);
	bpv__ObjectClass__pf.Add(nullptr);
	bpv__ObjectClass__pf.Add(nullptr);
	PrimaryActorTick.bStartWithTickEnabled = false;
	bReplicateMovement = true;
	InitialLifeSpan = 2.500000f;
}
PRAGMA_ENABLE_OPTIMIZATION
void AUzi_Bullet1_C__pf359902852::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void AUzi_Bullet1_C__pf359902852::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__11 = NewObject<USceneComponent>(InDynamicClass, USceneComponent::StaticClass(), TEXT("DefaultSceneRoot_GEN_VARIABLE"));
	InDynamicClass->ComponentTemplates.Add(__Local__11);
	auto __Local__12 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"));
	...
	__Local__13.ComponentPropertyName = FName(TEXT("Box"));
	__Local__13.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__13.FunctionNameToBind = FName(TEXT("BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AUzi_Bullet1_C__pf359902852::bpf__ExecuteUbergraph_Uzi_Bullet1__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_ApplyDamage_ReturnValue__pf = UGameplayStatics::ApplyDamage(b0l__K2Node_ComponentBoundEvent_OtherActor__pf, 5.000000, ((AController*)nullptr), this, ((UClass*)nullptr));
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = AActor::K2_GetActorLocation();
	bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AUzi_Bullet1_C__pf359902852::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), FVector(0.400000,0.400000,0.400000), true, EPSCPoolMethod::None);
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void AUzi_Bullet1_C__pf359902852::bpf__ExecuteUbergraph_Uzi_Bullet1__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 4:
			{
				bpfv__CallFunc_GetObjectClass_ReturnValue__pf = UGameplayStatics::GetObjectClass(b0l__K2Node_Event_Other__pf);
				bpfv__CallFunc_Array_Contains_ReturnValue__pf = FCustomThunkTemplates::Array_Contains(bpv__ObjectClass__pf, bpfv__CallFunc_GetObjectClass_ReturnValue__pf);
		...
		case 5:
			{
				...
				bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue1__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(AUzi_Bullet1_C__pf359902852::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), FVector(0.150000,0.150000,0.150000), true, EPSCPoolMethod::None);
			}
		case 6:
			{
				K2_DestroyActor();
...
void AUzi_Bullet1_C__pf359902852::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Uzi_Bullet1__pf_0(7);
}
void AUzi_Bullet1_C__pf359902852::bpf__ReceiveHit__pf(UPrimitiveComponent* bpp__MyComp__pf, AActor* bpp__Other__pf, UPrimitiveComponent* bpp__OtherComp__pf, bool bpp__bSelfMoved__pf, FVector bpp__HitLocation__pf, FVector bpp__HitNormal__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	...
	bpf__ExecuteUbergraph_Uzi_Bullet1__pf_1(3);
}
void AUzi_Bullet1_C__pf359902852::bpf__UserConstructionScript__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void AUzi_Bullet1_C__pf359902852::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AUzi_Bullet1_C__pf359902852::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AUzi_Bullet1_C__pf359902852
{
	FRegisterHelper__AUzi_Bullet1_C__pf359902852()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Igra/Oruzje/Ammunition/Uzi_Bullet1"), &AUzi_Bullet1_C__pf359902852::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AUzi_Bullet1_C__pf359902852 Instance;
};
FRegisterHelper__AUzi_Bullet1_C__pf359902852 FRegisterHelper__AUzi_Bullet1_C__pf359902852::Instance;
