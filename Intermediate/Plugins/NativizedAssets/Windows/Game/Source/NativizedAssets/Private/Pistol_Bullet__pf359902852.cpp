...
APistol_Bullet_C__pf359902852::APistol_Bullet_C__pf359902852(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (APistol_Bullet_C__pf359902852::StaticClass() == GetClass()))
	{
		APistol_Bullet_C__pf359902852::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__ProjectileMovement__pf->InitialSpeed = 15000.000000f;
	bpv__ProjectileMovement__pf->ProjectileGravityScale = 0.000000f;
	bpv__ProjectileMovement__pf->Velocity = FVector(150000.000000, 0.000000, 0.000000);
	...
	bpv__Cube__pf->AttachToComponent(bpv__Box__pf, FAttachmentTransformRules::KeepRelativeTransform );
	auto& __Local__10 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__Cube__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__10 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(APistol_Bullet_C__pf359902852::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(APistol_Bullet_C__pf359902852::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	auto& __Local__12 = (*(AccessPrivateProperty<FCollisionResponse >(&(bpv__Cube__pf->BodyInstance), FBodyInstance::__PPO__CollisionResponses() )));
	auto& __Local__13 = (*(AccessPrivateProperty<TArray<FResponseChannel> >(&(__Local__12), FCollisionResponse::__PPO__ResponseArray() )));
	__Local__13 = TArray<FResponseChannel> ();
	__Local__13.AddUninitialized(7);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__13.GetData(), 7);
	auto& __Local__14 = __Local__13[0];
	__Local__14.Channel = FName(TEXT("Enemy_Human"));
	__Local__14.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__15 = __Local__13[1];
	__Local__15.Channel = FName(TEXT("Friendly"));
	__Local__15.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__16 = __Local__13[2];
	__Local__16.Channel = FName(TEXT("NasTrigger"));
	__Local__16.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__17 = __Local__13[3];
	__Local__17.Channel = FName(TEXT("Enemy_Bullet"));
	__Local__17.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__18 = __Local__13[4];
	__Local__18.Channel = FName(TEXT("Bullet"));
	__Local__18.Response = ECollisionResponse::ECR_Overlap;
	auto& __Local__19 = __Local__13[5];
	__Local__19.Channel = FName(TEXT("Enemy_Trigger"));
	__Local__19.Response = ECollisionResponse::ECR_Ignore;
	auto& __Local__20 = __Local__13[6];
	__Local__20.Channel = FName(TEXT("OurHero"));
...
void APistol_Bullet_C__pf359902852::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APistol_Bullet_C__pf359902852::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__22 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"));
	InDynamicClass->DynamicBindingObjects.Add(__Local__22);
	__Local__21->bVisible = false;
	__Local__22->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__22->ComponentDelegateBindings.AddUninitialized(1);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__22->ComponentDelegateBindings.GetData(), 1);
	auto& __Local__23 = __Local__22->ComponentDelegateBindings[0];
	__Local__23.ComponentPropertyName = FName(TEXT("Box"));
	__Local__23.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__23.FunctionNameToBind = FName(TEXT("BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void APistol_Bullet_C__pf359902852::bpf__ExecuteUbergraph_Pistol_Bullet__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(APistol_Bullet_C__pf359902852::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), FVector(0.500000,0.500000,0.500000), true, EPSCPoolMethod::None);
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void APistol_Bullet_C__pf359902852::bpf__ExecuteUbergraph_Pistol_Bullet__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue1__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(APistol_Bullet_C__pf359902852::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), FVector(0.150000,0.150000,0.150000), true, EPSCPoolMethod::None);
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void APistol_Bullet_C__pf359902852::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Pistol_Bullet__pf_0(6);
}
void APistol_Bullet_C__pf359902852::bpf__ReceiveHit__pf(UPrimitiveComponent* bpp__MyComp__pf, AActor* bpp__Other__pf, UPrimitiveComponent* bpp__OtherComp__pf, bool bpp__bSelfMoved__pf, FVector bpp__HitLocation__pf, FVector bpp__HitNormal__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	typedef FHitResult  T__Local__25;
	T__Local__25& bpp__Hit__pf = *const_cast<T__Local__25 *>(&bpp__Hit__pf__const);
	...
	bpf__ExecuteUbergraph_Pistol_Bullet__pf_1(3);
}
void APistol_Bullet_C__pf359902852::bpf__UserConstructionScript__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void APistol_Bullet_C__pf359902852::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APistol_Bullet_C__pf359902852::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APistol_Bullet_C__pf359902852
{
	FRegisterHelper__APistol_Bullet_C__pf359902852()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Igra/Oruzje/Ammunition/Pistol_Bullet"), &APistol_Bullet_C__pf359902852::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APistol_Bullet_C__pf359902852 Instance;
};
FRegisterHelper__APistol_Bullet_C__pf359902852 FRegisterHelper__APistol_Bullet_C__pf359902852::Instance;
