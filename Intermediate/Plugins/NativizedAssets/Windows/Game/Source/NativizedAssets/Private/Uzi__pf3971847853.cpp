...
AUzi_C__pf3971847853::AUzi_C__pf3971847853(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (AUzi_C__pf3971847853::StaticClass() == GetClass()))
	{
		AUzi_C__pf3971847853::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__RotatingMovement__pf = CreateDefaultSubobject<URotatingMovementComponent>(TEXT("RotatingMovement"));
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(AUzi_C__pf3971847853::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(AUzi_C__pf3971847853::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	bpv__Cube__pf->BodyInstance.SetCollisionProfileName(FName(TEXT("NoCollision")));
	bpv__Cube__pf->RelativeScale3D = FVector(0.437500, 0.250000, 0.250000);
	...
	__Local__1 = ECollisionChannel::ECC_GameTraceChannel4;
	...
	__Local__3.AddUninitialized(15);
	FResponseChannel::StaticStruct()->InitializeStruct(__Local__3.GetData(), 15);
	...
	__Local__12.Channel = FName(TEXT("OurHero"));
	...
	__Local__14.Channel = FName(TEXT("Friendly"));
	...
	__Local__18.Channel = FName(TEXT("Enemy_Trigger"));
	__Local__18.Response = ECollisionResponse::ECR_Ignore;
	bpv__Box__pf->RelativeScale3D = FVector(1.781250, 3.937500, 1.687500);
	if(!bpv__Box__pf->IsTemplate())
	{
		bpv__Box__pf->BodyInstance.FixupData(bpv__Box__pf);
	}
	bpv__RotatingMovement__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__RotatingMovement__pf->RotationRate = FRotator(0.000000, 100.000000, 0.000000);
}
PRAGMA_ENABLE_OPTIMIZATION
void AUzi_C__pf3971847853::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	...
	if(bpv__RotatingMovement__pf)
	{
		bpv__RotatingMovement__pf->CreationMethod = EComponentCreationMethod::Native;
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void AUzi_C__pf3971847853::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(UGlobalPickUP_C__pf3966595016::StaticClass());
	...
	auto __Local__20 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"));
	...
	auto& __Local__21 = __Local__20->ComponentDelegateBindings[0];
	__Local__21.ComponentPropertyName = FName(TEXT("Box"));
	__Local__21.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__21.FunctionNameToBind = FName(TEXT("BndEvt__Box_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void AUzi_C__pf3971847853::bpf__ExecuteUbergraph_Uzi__pf_0(int32 bpp__EntryPoint__pf)
{
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue__pf{};
	UGlobalPickUP_C__pf3966595016* bpfv__CallFunc_Create_ReturnValue__pf{};
	FVector bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf(EForceInit::ForceInit);
	UAudioComponent* bpfv__CallFunc_SpawnSoundAtLocation_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 7);
	// optimized KCST_UnconditionalGoto
	b0l__K2Node_DynamicCast_AsOur_Hero__pf = Cast<AOurHero_C__pf3840320923>(b0l__K2Node_ComponentBoundEvent_OtherActor__pf);
	b0l__K2Node_DynamicCast_bSuccess__pf = (b0l__K2Node_DynamicCast_AsOur_Hero__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsOur_Hero__pf))
	{
		b0l__K2Node_DynamicCast_AsOur_Hero__pf->bpv__UziAcquiredx__pfzy = true;
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsOur_Hero__pf))
	{
		b0l__K2Node_DynamicCast_AsOur_Hero__pf->bpf__UziEquipFunction__pf();
	}
	bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = AActor::K2_GetActorLocation();
	bpfv__CallFunc_SpawnSoundAtLocation_ReturnValue__pf = UGameplayStatics::SpawnSoundAtLocation(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(AUzi_C__pf3971847853::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), 1.000000, 1.000000, 0.000000, ((USoundAttenuation*)nullptr), ((USoundConcurrency*)nullptr), true);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UGlobalPickUP_C__pf3966595016>(UWidgetBlueprintLibrary::Create(this, UGlobalPickUP_C__pf3966595016::StaticClass(), bpfv__CallFunc_GetPlayerController_ReturnValue__pf), ECastCheckedType::NullAllowed);
	...
	if(::IsValid(bpfv__CallFunc_Create_ReturnValue__pf))
	{
		bpfv__CallFunc_Create_ReturnValue__pf->bpv__GlobalText__pf = FInternationalization::ForUseOnlyByLocMacroAndGraphNodeTextLiterals_CreateText(
	TEXT("UZI ACQUIRED"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("CAC52E104C140FCD7FA84CA0C3AB633E") /* Key */
	);
	}
	UUserWidget*  __Local__22 = ((UUserWidget*)nullptr);
	b0l__K2Node_DynamicCast_AsWeapon_Heat_Widget__pf = Cast<UWeapon_HeatWidget_C__pf1818634969>(((::IsValid(b0l__K2Node_DynamicCast_AsOur_Hero__pf)) ? (b0l__K2Node_DynamicCast_AsOur_Hero__pf->bpv__WeaponWidget__pf) : (__Local__22)));
	b0l__K2Node_DynamicCast_bSuccess1__pf = (b0l__K2Node_DynamicCast_AsWeapon_Heat_Widget__pf != nullptr);;
	if (!b0l__K2Node_DynamicCast_bSuccess1__pf)
	{
		return; //KCST_GotoReturnIfNot
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsWeapon_Heat_Widget__pf))
	{
		b0l__K2Node_DynamicCast_AsWeapon_Heat_Widget__pf->bpf__Uzi_Widget__pf();
	}
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void AUzi_C__pf3971847853::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Uzi__pf_0(7);
}
void AUzi_C__pf3971847853::bpf__UserConstructionScript__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void AUzi_C__pf3971847853::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{102, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/Igra/Oruzje/Weapon_Skelet/uzi_Mat.uzi_Mat 
		{100, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  SoundWave /Game/Igra/Sounds/gun_pickup.gun_pickup 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AUzi_C__pf3971847853::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{97, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.RotatingMovementComponent 
		...
		{98, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  WidgetBlueprintGeneratedClass /Game/Igra/Widgets/GlobalPickUP.GlobalPickUP_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AUzi_C__pf3971847853
{
	FRegisterHelper__AUzi_C__pf3971847853()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Igra/Oruzje/Uzi"), &AUzi_C__pf3971847853::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AUzi_C__pf3971847853 Instance;
};
FRegisterHelper__AUzi_C__pf3971847853 FRegisterHelper__AUzi_C__pf3971847853::Instance;
