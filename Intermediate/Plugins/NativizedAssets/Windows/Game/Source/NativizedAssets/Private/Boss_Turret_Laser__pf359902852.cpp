...
#include "Boss_Turret_Laser__pf359902852.h"
...
ABoss_Turret_Laser_C__pf359902852::ABoss_Turret_Laser_C__pf359902852(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABoss_Turret_Laser_C__pf359902852::StaticClass() == GetClass()))
	{
		ABoss_Turret_Laser_C__pf359902852::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	bpv__ProjectileMovement__pf->InitialSpeed = 2500.000000f;
	bpv__ProjectileMovement__pf->MaxSpeed = 2500.000000f;
	...
	__Local__14 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABoss_Turret_Laser_C__pf359902852::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABoss_Turret_Laser_C__pf359902852::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	bpv__PointLight__pf->LightGuid = FGuid(0x26F0E026, 0x4E7FC94B, 0xE6D69F86, 0x9C9C79F8);
...
void ABoss_Turret_Laser_C__pf359902852::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABoss_Turret_Laser_C__pf359902852::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__29 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"));
	...
	auto& __Local__30 = __Local__29->ComponentDelegateBindings[0];
	__Local__30.ComponentPropertyName = FName(TEXT("Cube"));
	__Local__30.DelegatePropertyName = FName(TEXT("OnComponentBeginOverlap"));
	__Local__30.FunctionNameToBind = FName(TEXT("BndEvt__Cube_K2Node_ComponentBoundEvent_3_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABoss_Turret_Laser_C__pf359902852::bpf__ExecuteUbergraph_Boss_Turret_Laser__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(ABoss_Turret_Laser_C__pf359902852::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf, FVector(0.100000,0.100000,0.100000), true, EPSCPoolMethod::None);
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void ABoss_Turret_Laser_C__pf359902852::bpf__ExecuteUbergraph_Boss_Turret_Laser__pf_1(int32 bpp__EntryPoint__pf)
{
	float bpfv__CallFunc_ApplyDamage_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 1);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_ApplyDamage_ReturnValue__pf = UGameplayStatics::ApplyDamage(b0l__K2Node_ComponentBoundEvent_OtherActor__pf, 3.000000, ((AController*)nullptr), ((AActor*)nullptr), ((UClass*)nullptr));
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void ABoss_Turret_Laser_C__pf359902852::bpf__BndEvt__Cube_K2Node_ComponentBoundEvent_3_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Boss_Turret_Laser__pf_1(1);
}
void ABoss_Turret_Laser_C__pf359902852::bpf__ReceiveHit__pf(UPrimitiveComponent* bpp__MyComp__pf, AActor* bpp__Other__pf, UPrimitiveComponent* bpp__OtherComp__pf, bool bpp__bSelfMoved__pf, FVector bpp__HitLocation__pf, FVector bpp__HitNormal__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	...
	T__Local__32& bpp__Hit__pf = *const_cast<T__Local__32 *>(&bpp__Hit__pf__const);
	...
	bpf__ExecuteUbergraph_Boss_Turret_Laser__pf_0(4);
}
void ABoss_Turret_Laser_C__pf359902852::bpf__UserConstructionScript__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void ABoss_Turret_Laser_C__pf359902852::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABoss_Turret_Laser_C__pf359902852::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABoss_Turret_Laser_C__pf359902852
{
	FRegisterHelper__ABoss_Turret_Laser_C__pf359902852()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Igra/Oruzje/Ammunition/Boss_Turret_Laser"), &ABoss_Turret_Laser_C__pf359902852::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABoss_Turret_Laser_C__pf359902852 Instance;
};
FRegisterHelper__ABoss_Turret_Laser_C__pf359902852 FRegisterHelper__ABoss_Turret_Laser_C__pf359902852::Instance;
