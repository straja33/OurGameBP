...
#include "PassCodeKey__pf3971847853.h"
...
APassCodeKey_C__pf3971847853::APassCodeKey_C__pf3971847853(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (APassCodeKey_C__pf3971847853::StaticClass() == GetClass()))
	{
		APassCodeKey_C__pf3971847853::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(APassCodeKey_C__pf3971847853::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(APassCodeKey_C__pf3971847853::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
...
void APassCodeKey_C__pf3971847853::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APassCodeKey_C__pf3971847853::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void APassCodeKey_C__pf3971847853::bpf__UserConstructionScript__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void APassCodeKey_C__pf3971847853::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{115, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/Igra/Textures/Textureee/PassKey_Mat.PassKey_Mat 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APassCodeKey_C__pf3971847853::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APassCodeKey_C__pf3971847853
{
	FRegisterHelper__APassCodeKey_C__pf3971847853()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Igra/Oruzje/PassCodeKey"), &APassCodeKey_C__pf3971847853::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APassCodeKey_C__pf3971847853 Instance;
};
FRegisterHelper__APassCodeKey_C__pf3971847853 FRegisterHelper__APassCodeKey_C__pf3971847853::Instance;
