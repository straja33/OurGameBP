...
ARobot_Laser_C__pf359902852::ARobot_Laser_C__pf359902852(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ARobot_Laser_C__pf359902852::StaticClass() == GetClass()))
	{
		ARobot_Laser_C__pf359902852::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	__Local__13 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ARobot_Laser_C__pf359902852::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ARobot_Laser_C__pf359902852::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
	...
	bpv__PointLight__pf->AttachToComponent(bpv__Box__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__PointLight__pf->AttenuationRadius = 150.000000f;
	bpv__PointLight__pf->LightGuid = FGuid(0x3A8C7770, 0x4B44E72C, 0x3954ACBC, 0x51E8AC33);
...
void ARobot_Laser_C__pf359902852::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ARobot_Laser_C__pf359902852::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ARobot_Laser_C__pf359902852::bpf__ExecuteUbergraph_Robot_Laser__pf_0(int32 bpp__EntryPoint__pf)
{
	float bpfv__CallFunc_ApplyDamage_ReturnValue__pf{};
	check(bpp__EntryPoint__pf == 5);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_ApplyDamage_ReturnValue__pf = UGameplayStatics::ApplyDamage(b0l__K2Node_ComponentBoundEvent_OtherActor__pf, 6.000000, ((AController*)nullptr), this, ((UClass*)nullptr));
	// optimized KCST_UnconditionalGoto
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void ARobot_Laser_C__pf359902852::bpf__ExecuteUbergraph_Robot_Laser__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	bpfv__CallFunc_SpawnEmitterAtLocation_ReturnValue__pf = UGameplayStatics::SpawnEmitterAtLocation(this, CastChecked<UParticleSystem>(CastChecked<UDynamicClass>(ARobot_Laser_C__pf359902852::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf, bpfv__CallFunc_K2_GetComponentRotation_ReturnValue__pf, FVector(0.100000,0.100000,0.100000), true, EPSCPoolMethod::None);
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void ARobot_Laser_C__pf359902852::bpf__BndEvt__Cube_K2Node_ComponentBoundEvent_3_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Robot_Laser__pf_0(5);
}
void ARobot_Laser_C__pf359902852::bpf__ReceiveHit__pf(UPrimitiveComponent* bpp__MyComp__pf, AActor* bpp__Other__pf, UPrimitiveComponent* bpp__OtherComp__pf, bool bpp__bSelfMoved__pf, FVector bpp__HitLocation__pf, FVector bpp__HitNormal__pf, FVector bpp__NormalImpulse__pf, FHitResult const& bpp__Hit__pf__const)
{
	...
	bpf__ExecuteUbergraph_Robot_Laser__pf_1(1);
}
void ARobot_Laser_C__pf359902852::bpf__UserConstructionScript__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void ARobot_Laser_C__pf359902852::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ARobot_Laser_C__pf359902852::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ARobot_Laser_C__pf359902852
{
	FRegisterHelper__ARobot_Laser_C__pf359902852()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Igra/Oruzje/Ammunition/Robot_Laser"), &ARobot_Laser_C__pf359902852::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ARobot_Laser_C__pf359902852 Instance;
};
FRegisterHelper__ARobot_Laser_C__pf359902852 FRegisterHelper__ARobot_Laser_C__pf359902852::Instance;
