...
#include "Pistol__pf3971847853.h"
...
APistol_C__pf3971847853::APistol_C__pf3971847853(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (APistol_C__pf3971847853::StaticClass() == GetClass()))
	{
		APistol_C__pf3971847853::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(APistol_C__pf3971847853::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__Cube__pf->OverrideMaterials = TArray<UMaterialInterface*> ();
	bpv__Cube__pf->OverrideMaterials.Reserve(1);
	bpv__Cube__pf->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(APistol_C__pf3971847853::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
...
void APistol_C__pf3971847853::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void APistol_C__pf3971847853::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__3 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"));
	...
	__Local__4.FunctionNameToBind = FName(TEXT("BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void APistol_C__pf3971847853::bpf__ExecuteUbergraph_Pistol__pf_0(int32 bpp__EntryPoint__pf)
{
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue__pf{};
	UWeapon_HeatWidget_C__pf1818634969* bpfv__CallFunc_Create_ReturnValue__pf{};
	APlayerController* bpfv__CallFunc_GetPlayerController_ReturnValue1__pf{};
	UGlobalPickUP_C__pf3966595016* bpfv__CallFunc_Create_ReturnValue1__pf{};
	...
	bpfv__CallFunc_Create_ReturnValue1__pf = CastChecked<UGlobalPickUP_C__pf3966595016>(UWidgetBlueprintLibrary::Create(this, UGlobalPickUP_C__pf3966595016::StaticClass(), bpfv__CallFunc_GetPlayerController_ReturnValue1__pf), ECastCheckedType::NullAllowed);
	if(::IsValid(bpfv__CallFunc_Create_ReturnValue1__pf))
	{
		bpfv__CallFunc_Create_ReturnValue1__pf->UUserWidget::AddToViewport(0);
	}
	if(::IsValid(bpfv__CallFunc_Create_ReturnValue1__pf))
	{
		bpfv__CallFunc_Create_ReturnValue1__pf->bpv__GlobalText__pf = FInternationalization::ForUseOnlyByLocMacroAndGraphNodeTextLiterals_CreateText(
	TEXT("PISTL ACQUIRED"), /* Literal Text */
	TEXT(""), /* Namespace */
	TEXT("7FFECE8840F28FACB9CDE284C0DFFC35") /* Key */
	);
	}
	...
	{
		b0l__K2Node_DynamicCast_AsOur_Hero__pf->bpv__PistolAcquired__pf = true;
	}
	bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = AActor::K2_GetActorLocation();
	bpfv__CallFunc_SpawnSoundAtLocation_ReturnValue__pf = UGameplayStatics::SpawnSoundAtLocation(this, CastChecked<USoundBase>(CastChecked<UDynamicClass>(APistol_C__pf3971847853::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed), bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, FRotator(0.000000,0.000000,0.000000), 0.500000, 1.000000, 0.000000, ((USoundAttenuation*)nullptr), ((USoundConcurrency*)nullptr), true);
	// optimized KCST_UnconditionalGoto
	bpfv__CallFunc_GetPlayerController_ReturnValue__pf = UGameplayStatics::GetPlayerController(this, 0);
	bpfv__CallFunc_Create_ReturnValue__pf = CastChecked<UWeapon_HeatWidget_C__pf1818634969>(UWidgetBlueprintLibrary::Create(this, UWeapon_HeatWidget_C__pf1818634969::StaticClass(), bpfv__CallFunc_GetPlayerController_ReturnValue__pf), ECastCheckedType::NullAllowed);
	...
	if(::IsValid(bpfv__CallFunc_Create_ReturnValue__pf))
	{
		bpfv__CallFunc_Create_ReturnValue__pf->bpf__Pistol_Widget__pf();
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsOur_Hero__pf))
	{
		b0l__K2Node_DynamicCast_AsOur_Hero__pf->bpv__WeaponWidget__pf = bpfv__CallFunc_Create_ReturnValue__pf;
	}
	if(::IsValid(b0l__K2Node_DynamicCast_AsOur_Hero__pf))
	{
		b0l__K2Node_DynamicCast_AsOur_Hero__pf->bpf__PistolEquipFunction__pf();
	}
	K2_DestroyActor();
	return; // KCST_GotoReturn
}
void APistol_C__pf3971847853::bpf__BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature__pf(UPrimitiveComponent* bpp__OverlappedComponent__pf, AActor* bpp__OtherActor__pf, UPrimitiveComponent* bpp__OtherComp__pf, int32 bpp__OtherBodyIndex__pf, bool bpp__bFromSweep__pf, FHitResult const& bpp__SweepResult__pf__const)
{
	...
	bpf__ExecuteUbergraph_Pistol__pf_0(7);
}
void APistol_C__pf3971847853::bpf__UserConstructionScript__pf()
{
}
PRAGMA_DISABLE_OPTIMIZATION
void APistol_C__pf3971847853::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{99, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Material /Game/Igra/Textures/Prison_Level/PistlTexture_Mat.PistlTexture_Mat 
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void APistol_C__pf3971847853::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__APistol_C__pf3971847853
{
	FRegisterHelper__APistol_C__pf3971847853()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/Igra/Oruzje/Pistol"), &APistol_C__pf3971847853::__StaticDependenciesAssets);
	}
	static FRegisterHelper__APistol_C__pf3971847853 Instance;
};
FRegisterHelper__APistol_C__pf3971847853 FRegisterHelper__APistol_C__pf3971847853::Instance;
