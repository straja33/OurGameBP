...
class UDamageType;
class AController;
#include "Barrel__pf1334495665.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Igra/Oruzje/Explosions/Barrel.Barrel_C", OverrideNativeName="Barrel_C"))
class ABarrel_C__pf1334495665 : public AActor
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="ACtors", Category="Default", OverrideNativeName="ACtors"))
	TArray<AActor*> bpv__ACtors__pf;
	...
	ABarrel_C__pf1334495665(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Barrel__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Barrel__pf_1(int32 bpp__EntryPoint__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="Explode"))
	virtual void bpf__Explode__pf();
public:
};
