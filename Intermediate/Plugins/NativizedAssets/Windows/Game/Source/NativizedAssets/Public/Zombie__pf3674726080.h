...
class UMaterial;
class APawn;
#include "Zombie__pf3674726080.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Igra/AI/BasicAIMeele/Zombie.Zombie_C", OverrideNativeName="Zombie_C"))
class AZombie_C__pf3674726080 : public ACharacter
{
public:
	GENERATED_BODY()
	...
	AZombie_C__pf3674726080(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Zombie__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Zombie__pf_1(int32 bpp__EntryPoint__pf);
