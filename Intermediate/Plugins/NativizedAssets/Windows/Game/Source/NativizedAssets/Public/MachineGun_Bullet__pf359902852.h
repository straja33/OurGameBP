...
class AActor;
#include "MachineGun_Bullet__pf359902852.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Igra/Oruzje/Ammunition/MachineGun_Bullet.MachineGun_Bullet_C", OverrideNativeName="MachineGun_Bullet_C"))
class AMachineGun_Bullet_C__pf359902852 : public AActor
{
public:
	GENERATED_BODY()
	...
	AMachineGun_Bullet_C__pf359902852(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_MachineGun_Bullet__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_MachineGun_Bullet__pf_1(int32 bpp__EntryPoint__pf);
