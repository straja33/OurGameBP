...
class AActor;
class AOurHero_C__pf3840320923;
class UWeapon_HeatWidget_C__pf1818634969;
#include "Uzi__pf3971847853.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Igra/Oruzje/Uzi.Uzi_C", OverrideNativeName="Uzi_C"))
class AUzi_C__pf3971847853 : public AActor
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="K2Node_DynamicCast_AsOur_Hero"))
	AOurHero_C__pf3840320923* b0l__K2Node_DynamicCast_AsOur_Hero__pf;
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="K2Node_DynamicCast_bSuccess"))
	bool b0l__K2Node_DynamicCast_bSuccess__pf;
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="K2Node_DynamicCast_AsWeapon_Heat_Widget"))
	UWeapon_HeatWidget_C__pf1818634969* b0l__K2Node_DynamicCast_AsWeapon_Heat_Widget__pf;
	...
	AUzi_C__pf3971847853(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Uzi__pf_0(int32 bpp__EntryPoint__pf);
