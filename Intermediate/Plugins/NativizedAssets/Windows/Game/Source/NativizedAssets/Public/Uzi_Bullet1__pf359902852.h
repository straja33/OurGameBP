...
class AActor;
#include "Uzi_Bullet1__pf359902852.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Igra/Oruzje/Ammunition/Uzi_Bullet1.Uzi_Bullet1_C", OverrideNativeName="Uzi_Bullet1_C"))
class AUzi_Bullet1_C__pf359902852 : public AActor
{
public:
	GENERATED_BODY()
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Object Class", Category="Default", OverrideNativeName="ObjectClass"))
	TArray<UClass*> bpv__ObjectClass__pf;
	...
	AUzi_Bullet1_C__pf359902852(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Uzi_Bullet1__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Uzi_Bullet1__pf_1(int32 bpp__EntryPoint__pf);
