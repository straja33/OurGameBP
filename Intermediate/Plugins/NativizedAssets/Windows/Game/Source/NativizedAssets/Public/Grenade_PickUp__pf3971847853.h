...
#include "Grenade_PickUp__pf3971847853.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Igra/Oruzje/Grenade_PickUp.Grenade_PickUp_C", OverrideNativeName="Grenade_PickUp_C"))
class AGrenade_PickUp_C__pf3971847853 : public AActor
{
public:
	GENERATED_BODY()
	...
	AGrenade_PickUp_C__pf3971847853(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Grenade_PickUp__pf_0(int32 bpp__EntryPoint__pf);
