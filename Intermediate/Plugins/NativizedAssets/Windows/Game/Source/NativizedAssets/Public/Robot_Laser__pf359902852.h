...
class AActor;
#include "Robot_Laser__pf359902852.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Igra/Oruzje/Ammunition/Robot_Laser.Robot_Laser_C", OverrideNativeName="Robot_Laser_C"))
class ARobot_Laser_C__pf359902852 : public AActor
{
public:
	GENERATED_BODY()
	...
	ARobot_Laser_C__pf359902852(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Robot_Laser__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Robot_Laser__pf_1(int32 bpp__EntryPoint__pf);
