...
class UMaterial;
class AActor;
#include "Robot_Shoot__pf821169853.generated.h"
UCLASS(config=Game, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Igra/AI/Robot_Shoot/Robot_Shoot.Robot_Shoot_C", OverrideNativeName="Robot_Shoot_C"))
class ARobot_Shoot_C__pf821169853 : public ACharacter
{
public:
	GENERATED_BODY()
	...
	ARobot_Shoot_C__pf821169853(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Robot_Shoot__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Robot_Shoot__pf_1(int32 bpp__EntryPoint__pf);
