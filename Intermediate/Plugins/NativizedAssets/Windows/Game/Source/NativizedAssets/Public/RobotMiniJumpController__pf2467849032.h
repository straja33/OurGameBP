...
#include "RobotMiniJumpController__pf2467849032.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Igra/AI/Robot_Mini_Jump/RobotMiniJumpController.RobotMiniJumpController_C", OverrideNativeName="RobotMiniJumpController_C"))
class ARobotMiniJumpController_C__pf2467849032 : public ADetourCrowdAIController
{
public:
	GENERATED_BODY()
	...
	ARobotMiniJumpController_C__pf2467849032(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_RobotMiniJumpController__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_RobotMiniJumpController__pf_1(int32 bpp__EntryPoint__pf);
