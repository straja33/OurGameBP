...
class AActor;
#include "Plasma_Bullet__pf359902852.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/Game/Igra/Oruzje/Ammunition/Plasma_Bullet.Plasma_Bullet_C", OverrideNativeName="Plasma_Bullet_C"))
class APlasma_Bullet_C__pf359902852 : public AActor
{
public:
	GENERATED_BODY()
	...
	APlasma_Bullet_C__pf359902852(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_Plasma_Bullet__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_Plasma_Bullet__pf_1(int32 bpp__EntryPoint__pf);
